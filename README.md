...
### 🚀 What I am planning to do in my second and third years of engineering :

* ⚡ **High-Performance Computing (HPC) & Systems:** low-level programming & optimization, parallel architectures, computer networks and building critical systems from the ground up.
* 🧠 **Artificial Intelligence:** Exploring advanced algorithms and how to integrate heavy AI models into constrained environments.
* ⚛️ **Quantum Technology:** Quantum computing and its applications

### 🛠️ My Toolkit

* **Languages:** C/C++, Python, Java, Ocaml JavaScript, HTML/CSS, PHP
